 ...
 */
public class Exc_1_3_33_DequeResizingArrayTest {
    @Test
    public void pushLeft() throws Exception {
        Exc_1_3_33_DequeResizingArray<Integer> deque = new Exc_1_3_33_DequeResizingArray<>();
        deque.pushLeft(3);
    ...
    public void popRight() throws Exception {
        Exc_1_3_33_DequeResizingArray<Integer> deque = new Exc_1_3_33_DequeResizingArray<>();deque.pushRight(2);
        deque.pushRight(1);
        deque.pushRight(0);
        deque.pushLeft(3);
        deque.pushLeft(4);
