...
/**
 * Created by BSijtsma on 24-08-2016.
 */
public class Exc_1_3_38_GeneralizedQDeleteKArrayTest {
    @Test
    public void insert() throws Exception {
        Exc_1_3_38_GeneralizedQDeleteKArray<Integer> GQ = new Exc_1_3_38_GeneralizedQDeleteKArray();
        GQ.insert(1);
        GQ.insert(2);
        GQ.insert(3);
        GQ.insert(4);
